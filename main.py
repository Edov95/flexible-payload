"""Main module for the training, validation and testing."""
    ...
    for j in range(steps):
        ...
        if j == training_step:
            ...
            for sample in samples:
                ...
                history = step_model.fit([np.asarray(fit_input)],
...
ax.set(xlabel='Validation step', ylabel='Mean Reward',
       title='Mean rewards for each step')
ax.grid()
